...
#' @export
run_sctype <- function(seurat_object, known_tissue_type = NULL, cluster_column = "seurat_clusters", assay = "RNA", scaled = TRUE, custom_marker_file = NULL, plot_umap = FALSE, plot_bubble = FALSE, name = "sctype_classification") {
